    ...
    <CRow>
        <CCol :sm="6" :lg="3">
            <CWidgetStatsD class="mb-4" style="--cui-card-cap-bg: #3b5998" :values="[
                ...
                <template #chart>
                    <CChart class="position-absolute w-100 h-100" type="line" :data="{
                        labels: [
                            'January',
                            'February',
                            'March',
        ...
        <CCol :sm="6" :lg="3">
            <CWidgetStatsD class="mb-4" style="--cui-card-cap-bg: #00aced" :values="[
        ...
        <CCol :sm="6" :lg="3">
            <CWidgetStatsD class="mb-4" style="--cui-card-cap-bg: #4875b4" :values="[
